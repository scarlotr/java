...
public class FilterTaskFormWidget_FilterTaskFormBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.geekbrains.gwt.client.FilterTaskFormWidget>, com.geekbrains.gwt.client.FilterTaskFormWidget.FilterTaskFormBinder {
  ...
  class Widgets {
    ...
    private com.google.gwt.user.client.ui.HorizontalPanel build_f_HorizontalPanel10() {
      ...
      f_HorizontalPanel10.add(get_status());
    ...
    private com.google.gwt.user.client.ui.Label build_f_Label11() {
      ...
      f_Label11.setText("Status:");

      return f_Label11;
    }

    /**
     * Getter for status called 1 times. Type: DEFAULT. Build precedence: 5.
     */
