// .ui.xml template last modified: 1576484264000
...
public class LoginForm_LoginFormBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.geekbrains.gwt.client.LoginForm>, com.geekbrains.gwt.client.LoginForm.LoginFormBinder {
  ...
  class Widgets {
    ...
    private com.google.gwt.user.client.ui.HorizontalPanel build_f_HorizontalPanel3() {
      ...
      f_HorizontalPanel3.add(get_textUsername());
    ...
    /**
     * Getter for textUsername called 1 times. Type: DEFAULT. Build precedence: 5.
     */
    private com.google.gwt.user.client.ui.TextBox get_textUsername() {
      return build_textUsername();
    }
    private com.google.gwt.user.client.ui.TextBox build_textUsername() {
      // Creation section.
      final com.google.gwt.user.client.ui.TextBox textUsername = (com.google.gwt.user.client.ui.TextBox) GWT.create(com.google.gwt.user.client.ui.TextBox.class);
      // Setup section.
      textUsername.setWidth("200px");
      textUsername.setName("username");

      this.owner.textUsername = textUsername;
